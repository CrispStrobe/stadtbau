...
> Microsoft Store and the Mac App Store), under the terms of service of those platforms,
> even where those terms impose restrictions on the recipient that are inconsistent with
> the AGPL. This permission applies only to conveying through such platforms by the
> Publishers themselves; it does not relieve the Publishers of the obligation to make the
> Corresponding Source of every conveyed version publicly available under the AGPL, and it
...
If you remove this permission from a copy of the Program, as section 7 allows, you must
also remove this file and the corresponding notice from the About screen.
